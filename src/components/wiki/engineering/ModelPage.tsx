...
// Shared layout for the 4 engineering model pages (RNAt, ML1, ML2, Kinetic).
// Pass a page's real write-up via `content`; pages without one yet fall back
// to placeholder copy. The structure itself (sections, TOC, image slots)
// stays the same across all 4.
